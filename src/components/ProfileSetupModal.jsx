        ...
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[28px] border border-[var(--border)] bg-[var(--panel-muted)] p-6">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="xenon-metric">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--muted)]">
                  Use letters, numbers, and underscores so classmates and teachers can recognise you easily.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="space-y-4">
              ...
              {error && (
                <div className="rounded-2xl border border-[var(--danger)]/20 bg-[var(--danger)]/10 px-4 py-3 text-sm text-[var(--danger)]">
                  {error}
                </div>
              )}
