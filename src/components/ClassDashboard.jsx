  ...
  return (
    ...
    >
      ...
      <aside className="lg:w-72 space-y-6">
        ...
        <div className="xenon-panel p-6 border-none bg-[var(--panel-soft)]">
      ...
      <main className="flex-1 space-y-8 mt-10 lg:mt-0">
        ...
        {tab === "overview" && (
          <div className="space-y-8">
            ...
            <div className="xenon-panel p-8 border-none bg-[var(--panel-soft)]">
        ...
        {tab === "plagiarism" && (
          <div className="space-y-6">
            ...
            {/* [TIER: SCHOOL] */}
            <div className="xenon-panel p-12 text-center bg-[var(--panel-soft)] border-none flex flex-col items-center justify-center">
...
export default function ClassDashboard() {
  ...
  return (
    <div className="space-y-8 pb-12">
      {/* Dynamic Header */}
      <motion.section 
        className="xenon-panel p-10 sm:p-14 relative overflow-hidden bg-[var(--panel-soft)] border-none"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      >
