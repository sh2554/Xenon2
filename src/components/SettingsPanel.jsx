...
const themes = [
  { value: "xenon-dark", label: "Xenon Dark", colors: ["#0E0E0E", "#be185d", "#F3F3F3"] },
...
export default function SettingsPanel() {
  ...
  return (
    <>
      <div className="settings-view settings-no-hover flex flex-col gap-6 lg:flex-row lg:items-start">
        <SettingsSidebar 
              ...
              <motion.div key="profile" {...motionProps} className="space-y-6">
                ...
                <div className="xenon-panel p-6 sm:p-8">
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                    ...
                    <button className="xenon-btn px-8 h-12" disabled={savingProfile} onClick={saveProfile}>
                  ...
                  <label className="mt-8 flex items-center gap-4 rounded-2xl border border-[var(--border)] bg-[var(--panel-soft)] p-4 cursor-pointer transition-colors">
                ...
                <div className="xenon-panel p-6 sm:p-8">
                  ...
                  {enrolledClass ? (
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <button className="xenon-btn px-10 h-16" onClick={connectClass}>Connect</button>
                    </div>
                  )}
                </div>
                  ...
                  {searchResults.length > 0 && (
                    <div className="grid gap-3 animate-in fade-in slide-in-from-top-2">
                      {searchResults.map((result) => {
                        ...
                        return (
                          <div key={result.id} className="xenon-panel-muted flex items-center justify-between p-4 rounded-2xl transition-all">
                            <div className="flex items-center gap-4">
                  ...
                  <div className="xenon-panel p-6 sm:p-8">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      {friends.map((friendship) => (
                        <div key={friendship.id} className="xenon-panel-muted group flex items-center justify-between p-4 rounded-2xl hover:bg-[var(--ghost-bg)] transition-colors">
                          <div className="flex items-center gap-3">
                          ...
                          <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button className="h-9 w-9 rounded-xl bg-[var(--panel-soft)] flex items-center justify-center hover:text-[var(--fg)] transition-colors" onClick={() => openProfilePreview(friendship.friend)} title="View Profile">
      ...
      <AnimatePresence>
        {previewProfile && (
          <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 p-4 md:p-8 backdrop-blur-md">
            ...
            >
              <div className="h-32 bg-[var(--accent)] relative">
              ...
              <div className="px-8 pb-10">
                ...
                <div className="mt-10 flex justify-end gap-3">
                  ...
                  {existingRelationships.get(previewProfile.id) === undefined && previewProfile.id !== profile?.id && (
                    <button className="xenon-btn px-8 h-12" onClick={() => addFriend(previewProfile.id)}>Add Friend</button>
                  )}
                </div>
              </div>
            </motion.div>
