...
export default function PastPapersPanel({ onNavigateToIde }) {
  ...
  return (
    <div className="space-y-6 pb-12">
      <motion.section 
        className="xenon-panel p-8 sm:p-10 relative overflow-hidden bg-[var(--panel-soft)] border-none"
            ...
            <div className="space-y-6">
              ...
              {!graded ? (
                ...
                <div
                  ...
                  className="xenon-panel p-8 text-center bg-[var(--panel-soft)] border border-[var(--accent)]/30 space-y-4"
                >
