        ...
        <div className="w-full rounded-[32px] border border-[var(--success)]/20 bg-black/80 p-6 shadow-[0_0_80px_rgba(0,255,140,0.08)] backdrop-blur sm:p-8">
          <div className="mb-5 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={finishInitOverlay}
                className="rounded-full border border-[var(--border)] px-3 py-1 text-xs text-[var(--muted)] hover:text-white hover:border-white/30 transition-colors"
              >
                Skip
              </button>
            </div>
